...
public class HempFarmer {
	public static Configuration config;
	  @Mod.Instance("hempfarmer")
	  public static HempFarmer instance;
	  @SidedProxy(clientSide="com.shruglabs.hempfarmer.proxy.ClientProxy", serverSide="com.shruglabs.hempfarmer.proxy.CommonProxy")
	  ...
	  public void onItemCraft(PlayerEvent.ItemCraftedEvent event)
	  {
	    ...
	    if ((item == HFItems.seeds_hemp_crushed) || (item == HFItems.seeds_indica_crushed) || (item == HFItems.seeds_sativa_crushed)) {
